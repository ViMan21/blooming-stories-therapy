        ...
        <>
            ...
            <body className="App-body">
                <div className='Faq-body'>
                    ...
                    {AccordionCard('How much does each session cost?', 'Each 50 minute session is $170.')}
                    {AccordionCard('Would my insurance cover these costs?', 'Many insurance plans do cover psychotherapy services. A receipt will be emailed to you following your appointment, which can be submitted to your insurance company, if applicable. It is recommended that you check with your insurance provider if they cover services from Register Psychotherapists. ')}
                </div>
            </body>
            {Footer()}
        </>
